...
subtitle: function(data) {
	return "Included? " + data.Include + " | " + data.Category + ": " + data.Usage + ": " + data.Description;
},
...
fields: ["Category", "Usage", "Description", "Include"],
...
html: function(isEvent, data) {
	...
	<div style="float: left; width: 99%;">
		...
		Usage: <input id="Usage" class="round" type="text" style="width:99%"><br>
...
init: function() {
	...
	glob.sendTargetChange(document.getElementById('Usage'), 'varNameContainer');
